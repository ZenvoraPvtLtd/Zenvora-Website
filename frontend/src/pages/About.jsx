...
const team = [
  { role: "Leadership", desc: "Visionary leaders with decades of combined industry experience across tech and business." },
  { role: "Engineers", desc: "Full-stack experts, cloud architects, and ML specialists building the future, one commit at a time." },
  { role: "Designers", desc: "UX/UI professionals who craft intuitive experiences that users love and businesses trust." },
  { role: "Strategists", desc: "Business analysts and consultants who turn complex problems into clear digital roadmaps." },
];
...
const About = () => {
  return (
    <div className="min-h-screen bg-black">
      {/* Hero */}
      <section className="relative overflow-hidden bg-linear-to-br from-gray-900 via-black to-gray-900 text-white py-28 border-b border-gray-800">
        <div className="absolute top-0 left-1/3 w-125 h-125 bg-cyan-500/5 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-1 gap-5">
              {/* Mission */}
              <div className="bg-linear-to-br from-cyan-500/10 to-blue-500/5 border border-cyan-500/20 rounded-2xl p-7">
              ...
              {/* Vision */}
              <div className="bg-linear-to-br from-purple-500/10 to-pink-500/5 border border-purple-500/20 rounded-2xl p-7">
                <div className="text-2xl mb-3">🔭</div>
                <h3 className="text-xl font-bold text-cyan-400 mb-3">
                  Our Vision
                </h3>
      ...
      {/* Core Values */}
      <section className="py-24 bg-linear-to-b from-gray-900 to-black border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {team.map((member, idx) => (
              ...
              >
                <div className="w-14 h-14 rounded-full bg-linear-to-br from-cyan-500/30 to-blue-600/20 border border-cyan-500/30 flex items-center justify-center mx-auto mb-4 text-2xl group-hover:scale-110 transition-transform duration-300">
                  {["👔", "💻", "🎨", "📋"][idx]}
                </div>
      ...
      {/* CTA */}
      <section className="py-24 bg-linear-to-br from-gray-900 via-black to-gray-900 border-t border-gray-800">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"
              className="bg-linear-to-r from-cyan-500 to-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:from-cyan-400 hover:to-blue-500 transition text-sm"
            >
              Get in Touch →
            </Link>
            <Link
