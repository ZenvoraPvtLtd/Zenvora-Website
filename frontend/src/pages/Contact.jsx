...
const ContactSection = ({ isPage = true }) => {
        ...
        <aside className="space-y-5 lg:sticky lg:top-24 lg:self-start">
          <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-950">
            ...
            <div className="mt-5 space-y-4">
              {/* <a
                href="mailto:hr@zenvorainfo.com?cc=ps2855074@gmail.com"
                onClick={(e) => {
                  e.preventDefault();
                  window.location.href = "mailto:hr@zenvorainfo.com?cc=ps2855074@gmail.com";
                }}
