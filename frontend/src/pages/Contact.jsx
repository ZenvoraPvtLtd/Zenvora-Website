...
const Contact = () => {
  ...
  return (
    <main className="home-page-container relative text-[var(--text)] overflow-hidden min-h-screen">
      {/* ── Fixed Background Video for Entire Contact Page ── */}
      <div className="fixed inset-0 w-full h-full z-0 pointer-events-none">
        ...
        >
          <source src="https://res.cloudinary.com/drynl8beg/video/upload/v1782718033/contract_tw4m7r.mp4" type="video/mp4" />
        </motion.video>
      ...
      <div className="relative z-10">
        <style>
          {`
            ...
            /* Hide the dot pattern backgrounds from ContactSection */
            ...
            .home-page-container textarea,
            .home-page-container select,
            ...
            .home-page-container textarea::placeholder {
