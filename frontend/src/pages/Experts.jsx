...
const Experts = () => {
  ...
  return (
    <main className="home-page-container relative text-[var(--text)] overflow-hidden min-h-screen">
      {/* ── Fixed Background Video for Entire Experts Page ── */}
      <div className="fixed inset-0 w-full h-full z-0 pointer-events-none">
        ...
        >
          <source src="https://res.cloudinary.com/dqzsyg3yr/video/upload/v1782591878/Our_Expert_buyben.mp4" type="video/mp4" />
        </motion.video>
